...
class Mage_Core_Block_Template extends Mage_Core_Block_Abstract
{
    ...
    public function fetchView($fileName)
    {
        ...
        if ($this->getShowTemplateHints()) {
            echo <<<HTML
<div style="position:relative; border:1px dotted red; margin:3px 1px; padding:18px 2px 2px 2px; zoom:1;">
...
HTML;
        ...
        try {
            ...
            if (strpos($includeFilePath, realpath($this->_viewDir)) === 0 || $this->_getAllowSymlinks()) {
                ...
                if (self::$_switcher) {
                    echo "<span style=\"border:1px dotted red; margin:6px 2px; zoom:1; font-size: 12px;\">not valid: $includeFilePath</span>";
                }
        ...
        if ($this->getShowTemplateHints()) {
            if (self::$_switcher) {
                if ($this->getData('debug_info_from_cache')) {
                    echo "<span style=\"border:1px dotted red; margin:6px 2px; zoom:1; font-size: 12px;\">from cache</span>";
                }
                if ($cacheKey = $this->getData('debug_info_save_cache')) {
                    echo "<span style=\"border:1px dotted red; margin:6px 2px; zoom:1; font-size: 12px;\">saved: $cacheKey</span>";
                }
            }
            echo '</div>';
        }
    ...
    protected function _toHtml()
    {
        if (!$this->getTemplate()) {
            if (self::$_switcher) {
                echo "<span style=\"border:1px dotted red; margin:6px 2px; padding:18px 2px 2px 2px; zoom:1; font-size: 12px;\">empty template</span>";
            }
            return '';
        }
